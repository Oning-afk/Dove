...
import com.future.model.AlipayConfig;
...
public class AliPayController {
    ...
    @ResponseBody
    public String goAlipay(Long id) throws Exception {
        ...
        String out_trade_no = snowFlake.nextId()+"";
        //付款金额，必填
        String total_amount = ""+offlineClass.getOfflineClassPrice();
        //订单名称，必填
        String subject = "购买"+offlineClass.getOfflineClassName();
        //商品描述，可空
