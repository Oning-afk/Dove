...
<head>
    ...
    <link rel="shortcut icon" href="img/cf137.ico" type="image/x-icon">
    ...
    <tr>
        <td colspan="3">
            <div class="header"><!-- 头部 begin -->
                ...
                <div class="nav_sub">
                    您好,13525434041&nbsp; | <a target="_blank" href="/">返回前台</a> | <a href="javascript:void(0);" onClick="refresh();">刷新</a> | <a href="http://try.51eduline.com/index.php?app=admin&mod=Public&act=logout">退出</a><br/>
                    <div id="TopTime"></div>
                </div>
                <div class="main_nav">
                ...
                <ul class="MenuList" id="root_statistics" style="display:none;">
                    ...
                    <li class="treemenu">
                        ...
                        <ul id="tree_4" class="submenu">
                            <!-- 第三级菜单 -->
                            <li><a id="menu_5" href="javascript:void(0)" onClick="switch_sub_menu('5', 'http://localhost:5880/statistics/visit');" class="submenuA" hidefocus="true" style="outline:none;">访问统计</a></li>
