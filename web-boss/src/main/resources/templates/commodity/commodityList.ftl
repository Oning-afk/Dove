...
<div id="container" class="so_main">
    ...
    <div class="Toolbar_inbox">
        ...
        <a onclick="admin.fold('search_form')" class="btn_a"><span>搜索</span></a><a onclick="admin.delGoodsAll('delGoodsAll',2)" class="btn_a"><span>禁用</span></a><a onclick="admin.delGoodsAll('delGoodsAll',0)" class="btn_a"><span>删除</span></a>
    </div>
    <!-- END TOOLBAR -->
