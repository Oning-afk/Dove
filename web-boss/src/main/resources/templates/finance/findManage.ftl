...
<div id="container" class="so_main">
    ...
    <div class="tit_tab">
        <ul>
            <li><a href="findDingdan"class="on">列表</a></li>
            <li><a href="addManagejs" >添加</a></li>
        </ul>
    </div>
    <!-- END TAB框 -->
    <!-- START 搜索配置 -->
    ...
    <div class="Toolbar_inbox">
        ...
        <a onclick="delDingdan()" class="btn_a"><span>删除</span></a>
    </div>
    <!-- END TOOLBAR -->
    ...
    <div class="list" id='list'>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <#list cardVoucherPageBean.list as findManange>
                <tr>
                    <td><input type="checkbox" value="${findManange.id}" onclick="admin.checkon(this)"  name="checkbox"></td>
                    <td>${findManange.id}</td>
                    <td>${findManange.className}</td>
                    <td>${findManange.classPrice}</td>
                    <td>${findManange.classBuyNumber}</td>
                    <td>${findManange.classTotalePeople}</td>
                    <td><img src=${findManange.classImage} width='60px' height='60px'></td>
                    <td>${findManange.classCreater}</td>
                    <td>${findManange.createTime}</td>
                    <td>
                        <a href="">编辑</a>|
                        <a href="">删除</a>
                    </td>
