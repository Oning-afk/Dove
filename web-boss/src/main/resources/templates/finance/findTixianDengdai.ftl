...
<div id="container" class="so_main">
    ...
    <div class="Toolbar_inbox">
        ...
        <a onclick="admin.delCouponCard()" class="btn_a"><span>批量通过</span></a>
    </div>
    <!-- END TOOLBAR -->
    ...
    <div class="list" id='list'>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <th class="line_l"   >提现类型</th>
                <th class="line_l"   >提现人</th>
                <th class="line_l"   >提现账户</th>
                <th class="line_l"   >申请时间</th>
                <th class="line_l"   >状态</th>
                <th class="line_l"   style="width:auto;" >操作</th>
            </tr>
            <#list cardVoucherPageBean.list as findTixian>
                <tr>
                    <td><input type="checkbox" value="${findTixian.id}" onclick="admin.checkon(this)"  name="checkbox"></td>
                    <td>${findTixian.id}</td>
                    <td>${findTixian.name}</td>
                    <td>${findTixian.tixianjine}</td>
                    <td>${findTixian.tixianleixing}</td>
                    <td>${findTixian.tixianren}</td>
                    <td>${findTixian.tixianzhanghu}</td>
                    <td>${findTixian.shenqingshijian}</td>
                    <td>${findTixian.zhaungtai}</td>
                    <td>
                        <a href="">查看明细</a>|
                    </td>
                </tr>
