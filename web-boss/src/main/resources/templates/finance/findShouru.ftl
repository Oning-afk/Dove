    ...
    <div class="list" id='list'>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <th class="line_l"   >可用收入</th>
                <th class="line_l"   >冻结收入</th>
                <th class="line_l"   style="width:auto;" >操作</th>
            </tr>
            <#list cardVoucherPageBean.list as findShouru>
                <tr>
                    <td><input type="checkbox" value="${findShouru.id}" onclick="admin.checkon(this)"  name="checkbox"></td>
                    <td>${findShouru.id}</td>
                    <td>${findShouru.name}</td>
                    <td>${findShouru.xingming}</td>
                    <td>${findShouru.shenfenzhenghao}</td>
                    <td>${findShouru.yonghuzu}</td>
                    <td>${findShouru.keyongshouru}</td>
                    <td>${findShouru.dongjieshouru}</td>
                    <td>
                        <a href="">编辑</a>|
                    </td>
                </tr>
