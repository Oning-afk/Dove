...
<div id="container" class="so_main">
    ...
    <div class="tit_tab">
        <ul>
            <li><a href="" class="on">点播下单</a></li>
            <li><a href="" >班级订单</a></li>
            <li><a href="" >直播课堂订单</a></li>
            <li><a href="" >线下课订单</a></li>
    ...
    <div class="list" id='list'>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <th class="line_l"   >订单价格</th>
                <th class="line_l"   >通过套餐</th>
                <th class="line_l"   >学习状态</th>
                <th class="line_l"   >退款状态</th>
                <th class="line_l"   >订单课程有效天数</th>
                <th class="line_l"   >有效期至</th>
                <th class="line_l"   >退款时间</th>
                <th class="line_l"   style="width:auto;" >操作</th>
            </tr>
            <#list cardVoucherPageBean.list as finTuikuan>
                <tr>
                    <td><input type="checkbox" value="${finTuikuan.id}" onclick="admin.checkon(this)"  name="checkbox"></td>
                    <td>${finTuikuan.id}</td>
                    <td>${finTuikuan.name}</td>
                    <td>${finTuikuan.jigou}</td>
                    <td>${finTuikuan.kecheng}</td>
                    <td>${finTuikuan.yuanjia}</td>
                    <td>${finTuikuan.zhekou}</td>
                    <td>${finTuikuan.zhekouleixing}</td>
                    <td>${finTuikuan.dingdanjiage}</td>
                    <td>${finTuikuan.tongguotaocan}</td>
                    <td>${finTuikuan.tuikuanzhuangtai}</td>
                    <td>${finTuikuan.xuexizhaungtai}</td>
                    <td>${finTuikuan.youxiaotianshu}</td>
                    <td>${finTuikuan.youxiaoqi}</td>
                    <td>${finTuikuan.tuikuanshij}</td>
                    <td>
                        <a href="">查看详细</a>|
                    </td>
                </tr>
