...
<div id="container" class="so_main">
    ...
    <div class="Toolbar_inbox">
        ...
        <a onclick="admin.delCouponCard()" class="btn_a"><span>导出</span></a>
    </div>
    <!-- END TOOLBAR -->
    ...
    <div class="list" id='list'>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <th class="line_l"   >持卡者</th>
                <th class="line_l"   >姓名</th>
                <th class="line_l"   >开户行</th>
                <th class="line_l"   >账号</th>
                <th class="line_l"   >省市</th>
                <th class="line_l"   >开户行地址</th>
                <th class="line_l"   >联系人手机</th>
                <th class="line_l"   style="width:auto;" >操作</th>
            </tr>
            <#list cardVoucherPageBean.list as finKahao>
                <tr>
                    <td><input type="checkbox" value="${finKahao.id}" onclick="admin.checkon(this)"  name="checkbox"></td>
                    <td>${finKahao.id}</td>
                    <td>${finKahao.chikazhe}</td>
                    <td>${finKahao.name}</td>
                    <td>${finKahao.kaihuhang}</td>
                    <td>${finKahao.zhanghao}</td>
                    <td>${finKahao.shengshi}</td>
                    <td>${finKahao.kaihuhangdizhi}</td>
                    <td>${finKahao.lianxirenshouji}</td>
                    <td>
