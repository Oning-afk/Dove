    ...
    <div class="list" id='list'>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <th class="line_l"   >冻结余额</th>
                <th class="line_l"   >VIP类型</th>
                <th class="line_l"   style="width:auto;" >操作</th>
            </tr>
            <#list cardVoucherPageBean.list as finYue>
                <tr>
                    <td><input type="checkbox" value="${finYue.id}" onclick="admin.checkon(this)"  name="checkbox"></td>
                    <td>${finYue.id}</td>
                    <td>${finYue.name}</td>
                    <td>${finYue.xinming}</td>
                    <td>${finYue.shenfenzhenghao}</td>
                    <td>${finYue.yonghuquanxian}</td>
                    <td>${finYue.keyongyue}</td>
                    <td>${finYue.dongjieyue}</td>
                    <td>${finYue.vipleixing}</td>
                    <td>
                        <a href="">编辑</a>|
                    </td>
                </tr>
