    ...
    <div class="list" id='list'>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <th class="line_l"   >业务备注</th>
                <th class="line_l"   >创建时间</th>
                <th class="line_l"   >支付状态</th>
                <th class="line_l"   >订单号</th>
                <th class="line_l"   >支付方式</th>
            </tr>
            <#list cardVoucherPageBean.list as finZhifu>
                <tr>
                    <td><input type="checkbox" value="${finZhifu.id}" onclick="admin.checkon(this)"  name="checkbox"></td>
                    <td>${finZhifu.id}</td>
                    <td>${finZhifu.name}</td>
                    <td>${finZhifu.yonghuzu}</td>
                    <td>${finZhifu.jine}</td>
                    <td>${finZhifu.leixing}</td>
                    <td>${finZhifu.yewubeizhu}</td>
                    <td>${finZhifu.chuangjianshijian}</td>
                    <td>${finZhifu.zhifuzhuangtai}</td>
                    <td>${finZhifu.dingdanhao}</td>
                    <td>${finZhifu.zhifufangshi}</td>
                </tr>
            </#list>
