...
<div id="container" class="so_main">
    ...
    <div class="list" id='list'>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <#list cardVoucherPageBean.list as findJifen>
                <tr>
                    <td><input type="checkbox" value="${findJifen.id}" onclick="admin.checkon(this)"  name="checkbox"></td>
                    <td>${findJifen.id}</td>
                    <td>${findJifen.yonghuid}</td>
                    <td>${findJifen.yonghuming}</td>
                    <td>${findJifen.jifen}</td>
                    <td>
                        <a href="">编辑</a>|
