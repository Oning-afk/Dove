...
<div id="container" class="so_main">
    ...
    <div class="tit_tab">
        <ul>
            <li><a href="/operating/message/findMessagesList?isDel=0" >列表</a></li>
            <li><a href="/operating/message/findMessagesList?isDel=1" class="on">回收站</a></li>
            <!-- 列表 -->
        </ul>
    </div>
    <!-- END TAB框 -->
    ...
    <div class="Toolbar_inbox">
        ...
        <a onclick="admin.deleteMessages();" class="btn_a"><span>彻底删除</span></a>
    </div>
    <!-- END TOOLBAR -->
    <!-- START LIST -->
