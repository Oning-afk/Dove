...
<div id="container" class="so_main">
    <div class="tit_tab">
        ...
        <!-- END TAB框 -->
        <form name='detail_form' id="addClass" style="margin-top:5px">
            ...
            <div class="form2">
                ...
                <dl class="lineD">
                    ...
                    <dd>
                        <#if bean ?? && bean.cardClassType ??>
                            <#if bean.cardClassType == 1>
                                <label><input type="radio" name="cardClassType" value="1" node-type="点播" checked="checked">点播</label>
                                <label><input type="radio" name="cardClassType" value="2" node-type="直播" >直播</label>
                                <label><input type="radio" name="cardClassType" value="3" node-type="班级" >班级</label>
                                <#elseif bean.cardClassType == 2>
                                    <label><input type="radio" name="cardClassType" value="1" node-type="点播" >点播</label>
                                    <label><input type="radio" name="cardClassType" value="2" node-type="直播" checked="checked">直播</label>
                                    <label><input type="radio" name="cardClassType" value="3" node-type="班级" >班级</label>
                                <#elseif bean.cardClassType ==3>
                                    <label><input type="radio" name="cardClassType" value="1" node-type="点播" >点播</label>
                                    <label><input type="radio" name="cardClassType" value="2" node-type="直播" >直播</label>
                                    <label><input type="radio" name="cardClassType" value="3" node-type="班级" checked="checked">班级</label>
                            </#if>
                        <#else >
                            <label><input type="radio" name="cardClassType" value="1" node-type="点播" checked="checked">点播</label>
                            <label><input type="radio" name="cardClassType" value="2" node-type="直播" >直播</label>
                ...
                <dl class="lineD">
                    <dt><font color="red"> * </font>点播：</dt>
                    <dd>
                        <#if bean ?? && bean.cardClassId ??>
                            <input name="cardClassId" id="cardClassId" type="text" value="${bean.cardClassId?c}"  class="s-txt" style='width:200px'>
                        <#else >
                            <input name="cardClassId" id="cardClassId" type="text" class="s-txt" style='width:200px'>
                        </#if>
                        <p>请填写1-10的数字</p>
                    </dd>
                </dl>
    ...
    <script>
        function submitform(){
            admin.addCard($("#addClass").serialize());
        }
    </script>
