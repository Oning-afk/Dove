...
<div id="container" class="so_main">
    ...
    <div class="tit_tab">
        <ul>
            ...
            <li><a href="/operating/card/findCardVoucher?cardVoucherType=5"  class="on" >会员卡</a></li>
    ...
    <div class="form2" id='search_form' >
        <form>
            <input name="cardVoucherType" value="5" type="hidden">
    ...
    <div class="Toolbar_inbox">
        ...
        <a onclick="admin.addCoupon(5)" class="btn_a"><span>添加</span></a>
    ...
    <div class="list" id='list'>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <th class="line_l"   >vip等级</th>
                <th class="line_l"   >会员时限(天)</th>
                <th class="line_l"   >有效期（天）</th>
                <th class="line_l"   >会员卡数量</th>
            ...
            <#list cardVoucherPageBean.list as cardVoucher>
                <tr>
                    ...
                    <td>${cardVoucher.cardVipType?c}</td>
                    <td>${cardVoucher.cardVipDay?c}</td>
...
<script type="text/javascript">
    ...
    function searchList(page) {
        ...
        admin.searchList(page,3,id,institutionsId,cardVoucherNo);
    }
