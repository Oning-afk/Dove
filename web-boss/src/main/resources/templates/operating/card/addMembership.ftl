...
<div id="container" class="so_main">
    <div class="tit_tab">
        ...
        <form method="POST" action="http://try.51eduline.com/index.php?app=classroom&mod=AdminVip&act=doAddVip"  name='detail_form' style="margin-top:5px">
            <input type="hidden" name='systemdata_list' value="classroom_AdminVip"  class="s-txt"/>
            <input type="hidden" name='systemdata_key' value="addVip"  class="s-txt"/>
            ...
            <div class="form2">
                ...
                <dl class="lineD" id='dl_sort'>
                    ...
                    <dd>
                        <input name="sort" id="form_sort" type="text" value=""  class="s-txt" style='width:200px'>
                ...
                <dl class="lineD" id='dl_vip_month'>
                    <dt>月费：</dt>
                    <dd>
                        <input name="vip_month" id="form_vip_month" type="text" value=""  class="s-txt" style='width:200px'>
                ...
                <dl class="lineD" id='dl_vip_year'>
                    <dt>年费：</dt>
                    <dd>
                        <input name="vip_year" id="form_vip_year" type="text" value=""  class="s-txt" style='width:200px'>
                        <p>单位：元</p>
