...
<div id="container" class="so_main">
    ...
    <div class="tit_tab">
        <ul>
            ...
            <li><a href="/operating/card/findCardVoucher?cardVoucherType=3"  class="on" >课程卡</a></li>
    ...
    <!-- START 搜索框 -->
    <div id='search_form' class="form2">
        <form>
            ...
            <dl class="lineD" id='dl_code'>
                ...
                <dd>
                    <#if bean ?? && bean.cardVoucherNo ??>
                        <input name="cardVoucherNo" id="cardVoucherNo" type="text" value="${bean.cardVoucherNo}"  class='s-txt' style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" >
                    <#else >
            ...
            <dl class="lineD" id='dl_code'>
                <dt>课程类型：</dt>
                <dd>
                    <label><input type="radio" name="cardClassType" value='1'>点播 </label>
                    <label><input type="radio" name="cardClassType" value='2'>直播 </label>
                    <label><input type="radio" name="cardClassType" value='3'>班级 </label>
                </dd>
            </dl>
            <div class="page_btm">
            ...
            <#list cardVoucherPageBean.list as cardVoucher>
                <tr>
                    ...
                    <td>
                        ...
                        <#if cardVoucher.cardClassType == 2>
                            直播
                        </#if>
                        <#if cardVoucher.cardClassType == 3>
                            班级
                        </#if>
                    </td>
                    <td>${cardVoucher.cardClassId?c}</td>
...
<script type="text/javascript">
    ...
    function searchList(page) {
        ...
        admin.searchList(page,5,id,institutionsId,cardVoucherNo);
    }
    function reset_search() {
        var url = $('#search_form form ').attr('action');
        window.location.href = url+"?cardVoucherType=3";
    }
