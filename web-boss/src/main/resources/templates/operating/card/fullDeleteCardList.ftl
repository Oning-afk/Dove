...
<div id="container" class="so_main">
    ...
    <div class="tit_tab">
        <ul>
            <li><a href="/operating/card/findCardVoucher?cardVoucherType=1"  class="on" >优惠券</a></li>
    ...
    <div class="Toolbar_inbox">
        ...
        <a onclick="admin.addCoupon(1)" class="btn_a"><span>添加</span></a>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <#list cardVoucherPageBean.list as cardVoucher>
                <tr>
                    ...
                    <td>${cardVoucher.cardFull?c}</td>
                    <td>${cardVoucher.cardDelete?c}</td>
...
<script type="text/javascript">
    ...
    function searchList(page) {
        ...
        admin.searchList(page,1,id,institutionsId,cardVoucherNo);
    }
