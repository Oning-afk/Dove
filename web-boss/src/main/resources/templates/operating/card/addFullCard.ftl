...
<div id="container" class="so_main">
    <div class="tit_tab">
        ...
        <!-- END TAB框 -->
        <form name='detail_form' id="addFull" style="margin-top:5px">
            ...
            <div class="form2">
                <dl class="lineD" id='dl_sid'>
                    ...
                    <dd>
                        ...
                        <input name="cardVoucherType" id="cardVoucherType" type="hidden" value="1">
                ...
                <dl class="lineD" id='dl_maxprice'>
                    ...
                    <dd>
                        <#if bean ?? && bean.cardFull ??>
                            <input name="cardFull" id="cardFull" type="text" value="${bean.cardFull?c}"  class="s-txt" style='width:200px'>
                        <#else >
                            <input name="cardFull" id="cardFull" type="text" class="s-txt" style='width:200px'>
                        </#if>
                    </dd>
                </dl>
                <dl class="lineD" id='dl_price'>
                    ...
                    <dd>
                        <#if bean ?? && bean.cardDelete ??>
                            <input name="cardDelete" id="cardDelete" type="text" value="${bean.cardDelete?c}"  class="s-txt" style='width:200px'>
                        <#else >
                            <input name="cardDelete" id="cardDelete" type="text" value=""  class="s-txt" style='width:200px'>
                        </#if>
                    </dd>
                </dl>
    ...
    <script>
        function submitform(){
            admin.addCard($("#addFull").serialize());
        }
    </script>
