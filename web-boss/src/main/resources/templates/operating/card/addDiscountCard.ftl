...
<div id="container" class="so_main">
    <div class="tit_tab">
        ...
        <!-- END TAB框 -->
        <form name='detail_form' id="addDiscount" style="margin-top:5px">
            ...
            <div class="form2">
                <dl class="lineD" id='dl_sid'>
                    ...
                    <dd>
                        ...
                        <input name="cardVoucherType" id="cardVoucherType" type="hidden" value="2">
                ...
                <dl class="lineD" id='dl_maxprice'>
                    ...
                    <dd>
                        <#if bean ?? && bean.cardDiscount ??>
                            <input name="cardDiscount" id="cardDiscount" type="text" value="${bean.cardDiscount?c}"  class="s-txt" style='width:200px'>
                        <#else >
                            <input name="cardDiscount" id="cardDiscount" type="text" class="s-txt" style='width:200px'>
                        </#if>
                        <p>请填写1-10的数字</p>
                    </dd>
                </dl>
    ...
    <script>
        function submitform(){
            admin.addCard($("#addDiscount").serialize());
        }
    </script>
