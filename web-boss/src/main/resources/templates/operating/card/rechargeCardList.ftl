...
<div id="container" class="so_main">
    ...
    <div class="tit_tab">
        <ul>
            ...
            <li><a href="/operating/card/findCardVoucher?cardVoucherType=4"  class="on" >充值卡</a></li>
            ...
            <dl class="lineD" id='dl_sid'>
                ...
                <dd>
                    <#if bean ?? && bean.cardRecharge ??>
                        <input name="cardRecharge" id="cardRecharge" type="text" value="${bean.cardRecharge?c}"  class='s-txt' style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" >
                    <#else >
                        <input name="cardRecharge" id="cardRecharge" type="text" value=""  class='s-txt' style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" >
                    </#if>
                </dd>
            </dl>
            <div class="page_btm">
    ...
    <div class="Toolbar_inbox">
        ...
        <a onclick="admin.addCoupon(4)" class="btn_a"><span>添加</span></a>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <#list cardVoucherPageBean.list as cardVoucher>
                <tr>
                    ...
                    <td>${cardVoucher.cardRecharge?c}</td>
...
<script type="text/javascript">
    ...
    function searchList(page) {
        var id = $("#id").val();
        var cardRecharge =$("#cardRecharge").val();
        var cardVoucherNo =$("#cardVoucherNo").val();
        admin.searchList(page,4,id,null,cardVoucherNo,cardRecharge);
    }
