...
<div id="container" class="so_main">
    ...
    <div id='page_config' class = "form2 list" >
        ...
        <form action="http://try.51eduline.com/index.php?app=admin&mod=Index&act=savePageConfig" method="POST">
            <input type="hidden" name='pageKey' value="mall_AdminGoods_close"  class="s-txt"/>
    ...
    <div id='search_config' class = "form2 list" >
        ...
        <form action="http://try.51eduline.com/index.php?app=admin&mod=Index&act=saveSearchConfig" method="POST">
            <input type="hidden" name='searchPageKey' value="S_mall_AdminGoods_close" />
            <input type="hidden" name='pageTitle' value="回收站" />
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    <th>字段</th>
    ...
    <div class="form2" id='search_form' >
        <form action="http://try.51eduline.com/index.php?app=mall&mod=AdminGoods&act=close&dosearch=1" method="post">
    ...
    <div class="Toolbar_inbox">
       ...
       <#-- <a onclick="admin.fold('search_form')" class="btn_a"><span>搜索</span></a>--><a onclick="admin.delCouponAll()" class="btn_a"><span>启用</span></a> <a onclick="admin.deleteCommodity()" class="btn_a"><span>彻底删除</span></a>
    </div>
    <!-- END TOOLBAR -->
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <#list commodityShowPageBean.list as commodity>
                <tr>
                    ...
                    <td>
                        <#-- <#if commodity.state == 0>
                             <a onclick="admin.mzdelCouponCard(${commodity.id?c})" class="btn_a"><span>删除</span></a>|
                         </#if>-->
                        <#if commodity.state == 0 >
            ...
            <tr>
                <td colspan="15" align="right">
                    <!-- 如果总页数为0 -->
                    <#if commodityShowPageBean.totalRecord == 0>
                    </#if>
                    <#if commodityShowPageBean.totalRecord &gt; 0>
                        <a href="/mall/findCommodity?page=1">首页</a>
                        <!-- 如果当前为第一页时,就没有上一页这个超链接显示 -->
                        <#if commodityShowPageBean ?? && commodityShowPageBean.pageNum == 1 && commodityShowPageBean.pageNum != commodityShowPageBean.totalPage>
                            <#list commodityShowPageBean.start..commodityShowPageBean.end as i>
                                <#if commodityShowPageBean.pageNum == i>
                                    ${i}
                                <#else >
                                    <a href="/mall/findCommodity?page=${i}">${i}</a>
                                </#if>
                            </#list>
                            <a href="/mall/findCommodity?page=${commodityShowPageBean.pageNum + 1}">下一页</a>
                        </#if>
                        <!-- 如果当前不是第一页,也不是最后一页时,则有上一页跟下一页 -->
                        <#if commodityShowPageBean.pageNum &gt;1 && commodityShowPageBean.pageNum &lt; commodityShowPageBean.totalPage>
                            <a href="/mall/findCommodity?page=${commodityShowPageBean.pageNum-1}">上一页</a>
                            <#list commodityShowPageBean.start..commodityShowPageBean.end as i>
                                <#if commodityShowPageBean.pageNum == i>
                                    ${i}
                                <#else >
                        ...
                        <!-- 如果当前为最后一页时,则没有下一页 -->
                        <#if commodityShowPageBean.pageNum == commodityShowPageBean.totalPage && commodityShowPageBean.pageNum != 1>
                            <a href="/mall/findCommodity?page=${commodityShowPageBean.pageNum-1}">上一页</a>
                            <#list commodityShowPageBean.start..commodityShowPageBean.end as i>
                                <#if commodityShowPageBean.pageNum == i>
                                    ${i}
                        ...
                        <a href="/mall/findCommodity?page=${commodityShowPageBean.totalPage}">尾页</a>
                    </#if>
                    共${commodityShowPageBean.totalRecord}条
                </td>
            </tr>
        </table>
    </div>
    ...
    <div class="Toolbar_inbox">
        <div class="page right"><span>共0条</span></div>
        <!-- 	<a onclick="admin.fold('search_form')" class="btn_a"><span>搜索</span></a><a onclick="admin.delGoodsAll('delGoodsAll',3)" class="btn_a"><span>彻底删除</span></a> -->
    </div>
    <!-- END BOTTOMBAR -->
</div>
<script>
