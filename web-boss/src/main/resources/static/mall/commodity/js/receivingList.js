...
admin.mzstartCouponAll = function(id) {
    ui.confirm('确定要进行此操作吗？', {
        yes: function() {
            $.post('/receiving/updateReceivingToUp',{id:id},function () {
...
admin.mzdelCouponAll = function(id) {
    ui.confirm('确定要进行此操作吗？', {
        yes: function() {
            $.post('../receiving/updateReceivingToDown',{id:id},function () {
                var callback = "location.href = location.href";
                ui.success("操作成功");
                setTimeout(callback,1500);
            })
...
//批量删除
admin.deleteReceiving = function(_id, type) {
    ...
    ui.confirm('确定要进行此操作吗？', {
        yes: function() {
            $.post('/receiving/deleteReceiving',{id:ids},function () {
                var callback = "location.href = location.href";
                ui.success("操作成功");
                setTimeout(callback,1500);
            })
