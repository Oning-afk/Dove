//批量删除
admin.delMembership1 = function(_id, type) {
    ...
    ui.confirm('确定要进行此操作吗？', {
        yes: function() {
            $.post('/membership/delMembership',{id:ids},function () {
...
admin.mzstartCouponAll1 = function(id) {
    ui.confirm('确定要进行此操作吗？', {
        yes: function() {
            $.post('/membership/updateStatusToUp',{id:id},function () {
                var callback = "location.href = location.href";
                ui.success("操作成功");
                setTimeout(callback,1500);
            })
...
admin.mzdelCouponAll = function(id) {
    ui.confirm('确定要进行此操作吗？', {
        yes: function() {
            $.post('/membership/updateStatusToDown',{id:id},function () {
                var callback = "location.href = location.href";
                ui.success("操作成功");
                setTimeout(callback,1500);
            })
